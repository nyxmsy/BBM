...
const en: Dict = {
  ...
  "checkout.pickup_warning": "If the order is not collected within 3 days, it will be revoked.",
...
const ar: Dict = {
  ...
  "checkout.pickup_warning": "إذا لم يتم استلام الطلب خلال 3 أيام، سيتم إلغاؤه.",
